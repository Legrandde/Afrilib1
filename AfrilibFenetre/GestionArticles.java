...
public class GestionArticles extends JPanel{
    public GestionArticles(){
        ...
        JTextField champsTitre = new JTextField("Titre de l'article");
        ...
        JTextField champsNombrePage = new JTextField("Nombre ");
...
//  Premiere logique de l'application 
        ajouter.addActionListener(new ActionListener(){
            ...
            public void actionPerformed(ActionEvent e){
                ...
                Bibliotheque.ajouter_document(titre, auteur,nomDePage, nomExemplaire , "Articles");
